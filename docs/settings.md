...
| Show Month-to-Date Spending | on/off | Adds a **Month to Date** row to each local spend-tracking provider, totaling usage from the first day of the current calendar month through today. Off by default. |
