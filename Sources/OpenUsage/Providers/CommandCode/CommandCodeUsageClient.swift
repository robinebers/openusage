...
struct CommandCodeUsageClient: Sendable {
    ...
    func fetchWhoami(apiKey: String) async throws -> HTTPResponse { try await get(Self.whoamiURL, apiKey: apiKey) }
    ...
    private func get(_ baseURL: URL, apiKey: String,
                     query: [URLQueryItem] = []) async throws -> HTTPResponse {
