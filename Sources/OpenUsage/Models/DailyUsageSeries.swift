...
struct LogUsageScan: Sendable {
    ...
    init(
        ...
        unknownModelsByDay: [String: Set<String>], fallbackPricingModels: Set<String>? = nil
    ) {
        self.series = series
        self.modelUsage = modelUsage
        self.unknownModelsByDay = unknownModelsByDay
