...
/// funnels through `SpendTileMapper` (the Today / Yesterday / Last 30 Days / Month to Date tiles and the Usage Trend
/// chart).
///
...
/// here; `SpendTileMapper` snaps them to cents once for the displayed Today / Yesterday / Last 30 Days / Month to Date
