...
final class LocalLimitsAPITests: XCTestCase {
        ...
        let snapshot = ProviderSnapshot(
            ...
            lines: [
                .progress(
                    ...
                    resetsAt: OpenUsageISO8601.date(from: "2026-07-20T01:39:30.000Z"),
    ...
    func testUsageAndLimitsProjectTheSameRenderedSnapshot() throws {
        ...
        let limitsWeekly = try XCTUnwrap((limitsProvider["resources"] as? [String: Any])?["weekly"] as? [String: Any])

        XCTAssertEqual(usageLine["used"] as? Double, 73)
        XCTAssertEqual(limitsWeekly["used"] as? Double, 73)
    }
    ...
    func testEveryProviderDeclaresTheApprovedPublicResourceKeys() {
        ...
        let expected: [String: Set<String>] = [
            ...
            "codex": ["weekly", "spark", "sparkWeekly", "credits", "creditValue", "rateLimitResets"],
