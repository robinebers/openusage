...
final class CursorSpendProviderTests: XCTestCase {
    func testSpendTrackingDownloadsCSVExposesSpendTilesAndFlagsUnknownModels() async {
        ...
        // Today / Yesterday / Last 30 Days / Month to Date / Usage Trend lines
        ...
        for label in ["Today", "Yesterday", "Last 30 Days", "Month to Date", "Usage Trend"] {
        ...
        for id in ["cursor.today", "cursor.yesterday", "cursor.last30", "cursor.monthToDate", "cursor.trend"] {
