...
import { MenubarIconStyleSection } from "@/components/menubar-icon-style-section";
import { OpenAICompatibleSettingsSection } from "@/components/openai-compatible-settings-section";
import {
  AUTO_UPDATE_OPTIONS,
  ...
  return (
    <div className="py-3 space-y-4">
      ...
      <OpenAICompatibleSettingsSection
        ...
        localToken={openAIProxyLocalToken}
        onSettingsChange={onOpenAICompatibleSettingsChange}
        onUpstreamKeySave={onOpenAIProxyUpstreamKeySave}
        onLocalTokenReveal={onOpenAIProxyLocalTokenReveal}
        onLocalTokenCopy={onOpenAIProxyLocalTokenCopy}
        onLocalTokenRegenerate={onOpenAIProxyLocalTokenRegenerate}
      />
      <section>
