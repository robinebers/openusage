# Contributing to UsageTray

UsageTray is an unofficial Windows-focused fork of OpenUsage. Contributions are welcome, but the quality bar is high. Read this document before opening a PR.

## Philosophy

UsageTray is intentionally narrow in scope: tracking AI coding subscription usage on Windows without unnecessary complexity. Changes that drift away from that focus or degrade the UX will be closed.
...
- Match the existing design language. UsageTray has a specific look and feel.
...
You can also [open an issue](https://github.com/Rana-Faraz/usage-tray-windows/issues/new?template=new_provider.yml) to request a provider without building it yourself.
...
Don't open a PR for large features without discussing first. [Open an issue](https://github.com/Rana-Faraz/usage-tray-windows/issues/new?template=feature_request.yml) and make your case.
...
Open a [bug report](https://github.com/Rana-Faraz/usage-tray-windows/issues/new?template=bug_report.yml) or [feature request](https://github.com/Rana-Faraz/usage-tray-windows/issues/new?template=feature_request.yml) using the issue templates.
